...
var _microsoftGraphClient = __webpack_require__(45);

var graph = _interopRequireWildcard(_microsoftGraphClient);
            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        ...
                        _context.prev = 1;
                        _context.next = 4;
                        return _axios2.default.get('/token', {
                            params: {
                    ...
                    case 10:
                        return _context.abrupt('return', graph.Client.init({
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(43), __webpack_require__(21)))
...
var _graphClient = __webpack_require__(48);

var _graphClient2 = _interopRequireDefault(_graphClient);
        ...
        return _regenerator2.default.wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        _context.next = 2;
                        return (0, _graphClient2.default)();

                    case 2:
                        client = _context.sent;
                        users = void 0; // array of users

                        client.api('/users').get(function (err, res) {
                            console.log(res);
                            // users = res;
                        });
...
//# sourceMappingURL=458938c5f401b5db6861.users.js.map